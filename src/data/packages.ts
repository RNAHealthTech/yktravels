...
const packages: Package[] = [
  ...
  },
  {
    ...
    overview: {
      title: "Trek Overview",
      description: "The Nag Tibba Trek, curated by YK Travels, offers an enchanting journey through the serene landscapes of the Garhwal region in Uttarakhand. Rising to an altitude of 9,915 feet, Nag Tibba, also known as the “Serpent’s Peak,” is the highest peak in the lower Himalayas of Uttarakhand. This trek is a perfect blend of natural beauty, cultural immersion, and adventure, making it an ideal choice for both novice and seasoned trekkers.",
      activities: [
        {
          title: "",
          description: "",
